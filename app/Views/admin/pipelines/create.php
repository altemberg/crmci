...
<?= $this->section('page_content') ?>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Criar Novo Pipeline</h1>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <?= form_open('admin/pipelines/create') ?>
                <div class="mb-3">
                ...
                <div class="alert alert-info">
                    ...
                    Os seguintes estágios serão criados automaticamente: Novo Lead, Qualificação, Proposta, Negociação, Fechado/Ganho, Fechado/Perdido
                </div>
